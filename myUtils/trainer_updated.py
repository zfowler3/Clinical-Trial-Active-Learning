...
import Data.cxr_dataset as CXR

# sets up active learning flow
# every round:
# round 0: by the time round 1 comes and you add more samples, you need to delete these samples from the unlabeled pool
...
class Trainer_New(object):
    def __init__(self, args):
        ...
        self.prev_acc = np.zeros(len(test_loader), dtype=int)
